...
export async function run({ page, helpers, config }) {
  ...
  await injectAndOpen(page, sa.access_token, sa.session_uuid || sa.user?.uuid || null, '/rider-salary/period');
  ...
  await injectAndOpen(page, sa.access_token, sa.session_uuid || sa.user?.uuid || null, '/rider-salary/plan');
