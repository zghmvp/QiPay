...
from backend.plugin.rider_salary.utils.audit import _operator_name
...
def test_operator_falls_back_to_username() -> None:
    ...
    assert _operator_name(req) == 'admin'
