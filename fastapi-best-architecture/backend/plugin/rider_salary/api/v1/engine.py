...
@router.post('/validate', summary='校验条件与公式', dependencies=[DependsJwtAuth, DependsRBAC])
...
@router.post('/evaluate-sample', summary='即时预览求值', dependencies=[DependsJwtAuth, DependsRBAC])
