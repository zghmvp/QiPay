...
from backend.plugin.rider_salary.schema.advance import CreateMeAdvanceParam, GetAdvanceDetail, GetAdvanceQuota
...
class MeService:
    ...
    async def advance_quota(self, *, db: AsyncSession, rider: RiderSalaryRider) -> GetAdvanceQuota:
        data = await advance_service.monthly_quota_for_rider(db=db, rider=rider)
